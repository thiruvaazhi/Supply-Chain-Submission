...
contract SupplyChain is FarmerRole,DistributorRole,ConsumerRole,RetailerRole,Ownable {
  ...
  // Define a variable called 'sku' for Stock Keepin Unit (SKU)
  uint  sku;
 ...
 /* function kill() public {
  ...
  function harvestItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string  _originFarmLongitude, string  _productNotes) onlyFarmer() public 
  {
    ...
    items[sku]=Item({sku:sku, upc:_upc, ownerID:_originFarmerID, originFarmerID:_originFarmerID,       originFarmName:_originFarmName,originFarmInformation:_originFarmInformation,originFarmLatitude:_originFarmLatitude,originFarmLongitude:_originFarmLongitude,
    productID:_pid,productNotes:_productNotes,productPrice:1,itemState:State.Harvested,distributorID:0,
    retailerID:0,consumerID:0} );
    // Increment sku
    sku = sku + 1;
  ...
  function receiveItem(uint _upc) shipped(_upc) onlyRetailer() public 
    ...
    {
    // Update the appropriate fields - ownerID, retailerID,      
